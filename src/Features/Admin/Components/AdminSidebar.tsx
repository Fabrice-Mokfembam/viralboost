...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ isOpen, onClose, currentPath }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-bg-secondary transform transition-transform duration-300 ease-in-out lg:translate-x-0
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-center h-16 px-4 bg-bg-main border-b border-border">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-text-primary">ViralBoast</span>
            </div>
          </div>
          ...
          <div className="p-4 border-t border-border">
            <button
              ...
              className="flex items-center w-full px-4 py-3 text-sm font-medium text-text-secondary hover:bg-bg-tertiary hover:text-text-primary rounded-lg transition-colors duration-200"
            >
