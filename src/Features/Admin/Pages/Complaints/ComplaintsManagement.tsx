...
const dummyComplaints: Complaint[] = [
  {
    ...
    user: {
      ...
      phone: '+1234567890',
      membershipTier: { id: 1, membership_name: 'Basic', description: 'Basic membership', tasks_per_day: 5, max_tasks: 10, task_link: null, benefits: null, price: 0, reward_multiplier: '1', priority_level: 1, is_active: 1, created_at: '2024-01-01', updated_at: '2024-01-01' },
  ...
  },
  {
    ...
    user: {
      ...
      phone: '+1234567891',
      membershipTier: { id: 2, membership_name: 'Premium', description: 'Premium membership', tasks_per_day: 15, max_tasks: 30, task_link: null, benefits: null, price: 9.99, reward_multiplier: '1.5', priority_level: 2, is_active: 1, created_at: '2024-01-01', updated_at: '2024-01-01' },
  ...
  },
  {
    ...
    user: {
      ...
      phone: '+1234567893',
      membershipTier: { id: 3, membership_name: 'VIP', description: 'VIP membership', tasks_per_day: 50, max_tasks: 100, task_link: null, benefits: null, price: 29.99, reward_multiplier: '2', priority_level: 3, is_active: 1, created_at: '2024-01-01', updated_at: '2024-01-01' },
