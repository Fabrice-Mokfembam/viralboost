          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              <input
                ...
                className="appearance-none relative block w-full px-3 py-3 border border-gray-700 placeholder-gray-500 text-white rounded-md focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm bg-gray-700"
