...
const Withdraw = () => {
  ...
  const handleWithdraw = () => {
    ...
    // Add actual withdrawal logic
  };

  return (
    <div className="min-h-screen bg-gray-900 p-6 max-w-xl mx-auto text-gray-300">
      <h1 className="text-3xl font-bold text-cyan-400 mb-6">Withdraw Funds</h1>

      <div className="mb-6">
        <label className="block mb-2 font-semibold text-white">Amount to Withdraw</label>
        <input
          type="number"
          min="1"
      ...
      <div>
        <p className="mb-4 font-semibold text-white">Select Withdrawal Method</p>
